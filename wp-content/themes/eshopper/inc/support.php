...
function read_more_get_meta( $value ) {
	global $post;
...
function read_more_add_meta_box() {
	add_meta_box(
		'read_more-read-more',
		__( 'Read More', 'read_more' ),
		'read_more_html',
		'post',
		'normal',
		'default'
...
add_action( 'add_meta_boxes', 'read_more_add_meta_box' );

function read_more_html( $post) {
	wp_nonce_field( '_read_more_nonce', 'read_more_nonce' ); ?>

	<p>The blog post read more button</p>

	<p>
		<label for="read_more_read_more"><?php _e( 'Read More', 'read_more' ); ?></label><br>
		<input type="text" name="read_more_read_more" id="read_more_read_more" value="<?php echo read_more_get_meta( 'read_more_read_more' ); ?>">
	</p>	<p>
		<label for="read_more_read_more_link"><?php _e( 'Read More Link', 'read_more' ); ?></label><br>
		<input type="text" name="read_more_read_more_link" id="read_more_read_more_link" value="<?php echo read_more_get_meta( 'read_more_read_more_link' ); ?>">
	</p><?php
}

function read_more_save( $post_id ) {
	if ( defined( 'DOING_AUTOSAVE' ) && DOING_AUTOSAVE ) return;
	if ( ! isset( $_POST['read_more_nonce'] ) || ! wp_verify_nonce( $_POST['read_more_nonce'], '_read_more_nonce' ) ) return;
	if ( ! current_user_can( 'edit_post', $post_id ) ) return;

	if ( isset( $_POST['read_more_read_more'] ) )
		update_post_meta( $post_id, 'read_more_read_more', esc_attr( $_POST['read_more_read_more'] ) );
	if ( isset( $_POST['read_more_read_more_link'] ) )
		update_post_meta( $post_id, 'read_more_read_more_link', esc_attr( $_POST['read_more_read_more_link'] ) );
}
add_action( 'save_post', 'read_more_save' );

/*
	Usage: read_more_get_meta( 'read_more_read_more' )
	Usage: read_more_get_meta( 'read_more_read_more_link' )
*/
